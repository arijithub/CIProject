   ...
   <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
        <ul class="nav navbar-nav nav_1">
			...
			<li><a href="<?php echo base_url('Welcome/service_view'); ?>">Services</a></li>
            
			<li><a href="<?php echo base_url('Welcome/features_view'); ?>">Features</a></li>

			<li><a href="<?php echo base_url('Welcome/career_view'); ?>">Career</a></li>

			<li><a href="<?php echo base_url('Welcome/department_view'); ?>">Department</a></li>
           
			<li><a href="<?php echo base_url('Welcome/feedback'); ?>">Feedback</a></li>
          
			<li class="last"><a href="<?php echo base_url('Welcome/faculty_view'); ?>">Contacts</a></li>
        </ul>
     </div><!-- /.navbar-collapse -->
   </div>
</nav>
